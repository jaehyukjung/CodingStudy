...
public class BOJ_21918 {
    ...
    public static int[] command1(int[] bulb, int i, int x){
        int[] state = bulb;
        state[i-1] = x;
        return state;
    }
    public static int[] command2(int[] bulb, int l, int r){
        int[] state = bulb;
        for(int i = l-1; i < r; i++){
    ...
    public static int[] command3(int[] bulb, int l, int r){
        int[] state = bulb;
        for(int i = l-1; i < r; i++){
            state[i] = 0;
        }
    ...
    public static int[] command4(int[] bulb, int l, int r){
        int[] state = bulb;
        for(int i = l-1; i < r; i++){
            state[i] = 1;
        }
